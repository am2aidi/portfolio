...
- **Admin Panel**: Double-click the navbar logo (`Kwizera.`) or the footer copyright text, or press `Ctrl + Alt + E` to toggle the local Admin Editor directly. Add/edit projects, works, certificates, skills, hobbies, languages, and profile pictures.
...
1. Run the site locally and access the **Admin Panel** (by double-clicking the logo, footer, or pressing `Ctrl + Alt + E`).
